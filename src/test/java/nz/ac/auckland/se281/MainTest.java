...
public class MainTest {
  ...
  public static class YourTests extends CliTest {
    ...
    @Test
    public void T_01_your_own_test() throws Exception {
      runCommands(CREATE_PROFILE, "HEHEHEHEHHA", "sixtynine", PRINT_DB);
      assertContains(
          "'sixtynine' is an invalid age, please provide a positive whole number only. No profile was created for Hehehehehha");
      assertContains("Database has 0 profiles.");
    }

    @Test
    public void T_02_your_own_test() throws Exception {
      runCommands(CREATE_PROFILE, "SirBillyBobJoe", "420", LOAD_PROFILE, "SirBillyBobJoe", POLICY_LIFE,
          options("69420"), PRINT_DB);
      assertContains("New profile created for Sirbillybobjoe with age 420.");
      assertContains("Profile loaded for Sirbillybobjoe.");
      assertContains("Sirbillybobjoe is over the age limit. No policy was created");
      assertContains("Database has 1 profile:");
      assertContains("*** 1: Sirbillybobjoe, 420, 0 policies for a total of $0");
    }

    @Test
    public void T_03_your_own_test() throws Exception {
      runCommands(CREATE_PROFILE, "Jordan", "21", CREATE_PROFILE, "JoRDAn", "21", PRINT_DB);
      assertContains("New profile created for Jordan with age 21.");
      assertContains("Database has 1 profile:");
    ...
    /*
     * @Test
     * public void T_04_your_own_test() throws Exception {
     * runCommands(CREATE_PROFILE, "BOOBBYBBOOsd-0fdsf]]\[[;p]]", "21", PRINT_DB);
     * assertContains("Database has 0 profiles.");
     * assertContains(
     * "'Jo' is an invalid username, it should be at least 3 characters long. No profile was"
     * + " created.");
